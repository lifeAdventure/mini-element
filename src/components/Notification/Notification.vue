<template>
  ...
  >
    <div
      ref="notificationRef"
      v-show="visible"
      class="mini-notification"
      :class="{
        [`mini-notification--${type}`]: type,
        'is-close': showClose
      }"
      role="alert"
      :style="cssStyle"
    ...
    >
      <Icon class="mini-notification__icon" :icon="iconName" />
      <div class="mini-notification__text">
        <div class="mini-notification__title">{{ title }}</div>
        <div class="mini-notification__content">
          <RenderVnode :v-node="message" />
        </div>
      </div>
      <div class="mini-notification__close" v-if="showClose">
